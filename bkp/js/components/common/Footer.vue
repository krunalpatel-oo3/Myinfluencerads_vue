<template>
  ...
  <footer class="footer">
    ...
    <div class="container">
          ...
          <div class="row">
            <div class="col-sm-6">
              <ul class="nav flex-column mb-4 mb-sm-0">
                <li class="nav-item">
                  <router-link exact :to="{ name: 'Home' }" class="nav-link"><strong>Home</strong></router-link>
                </li>
                <li class="nav-item">
                  <router-link :to="{ name: 'About Us' }" class="nav-link">About</router-link>
                </li>
                <li class="nav-item">
                  <router-link :to="{ name: 'Contact Us' }" class="nav-link">Contact Us</router-link>
                </li>
                <li class="nav-item">
                  <router-link :to="{ name: 'Terms Conditions' }" class="nav-link">Terms & Conditions</router-link>
                </li>
                <li class="nav-item">
            ...
            <div class="col-sm-6">
              <ul class="nav flex-column">
                ...
                <li class="nav-item">
                  <router-link :to="{ name: 'education' }" class="nav-link"
      ...
      <div class="footer-b">
        <div class="copy">Copyrights {{new Date().getFullYear()}}. All rights reserved.</div>
        <div class="social">
          <a href="https://www.facebook.com/streamgeeks" target="_blank">
            <icon-base
              width="24"
              height="24"
              view-box="0 0 24 24"
          ...
          <a href="https://twitter.com/streamgeeks" target="_blank">
            <icon-base
              width="28"
              height="21"
              view-box="0 0 28 21"
          ...
          <a href="https://www.instagram.com/streamgeeks/" target="_blank">
            <icon-base
              width="24"
              height="24"
              view-box="0 0 24 24"
