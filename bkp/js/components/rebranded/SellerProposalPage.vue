    ...
    <div class="container">
      ...
      <div class="project-info">
        <div class="row">
          ...
          <div class="col-7">
            <div class="row w-100 d-flex justify-content-end align-items-end h-100">
              <div class="user-info">
                <div class="row align-items-center">
                  <img :src="`${publicPath}user_info.png`" width="60px" height="60px" alt="">
                  <router-link to="" class="w600 t-24 t-black my-0" style="margin-left: 12px">James K</router-link>
                </div>
                <div class="row" style="margin-top: 8.3px">
                  ...
                  <p class="t-24 w500 t-black" style="line-height: 24px; margin-left: 15.14px">4.7</p>
                </div>
                <div class="row">
                  <p class="w500 t-black t-16 mb-0">United States</p>
                  <p class="w500 t-black t-16 mb-0">10 projects posted, 6 hires</p>
                  <p class="w500 t-black t-16 mb-0">$1000 total spent</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <BottomMain v-if="type === ''"/>
      <PendingInvite v-if="type === 'pending-invite'"/>
      <ArchivedProposal v-if="type === 'archived-proposal'"/>
      <ArchivedInvite v-if="type === 'archived-invite'"/>
      <WaitingForAccept v-if="type === 'waiting-for-accept'"/>
      <ProjectInProgress v-if="type === 'in-progress'"/>
      <CompletedProject v-if="type === 'completed-project'" />
    </div>
...
import BottomMain from "./bottom_components/BottomMain.vue";
import PendingInvite from "./bottom_components/PendingInvite.vue";
import ArchivedProposal from "./bottom_components/ArchivedProposal";
import ArchivedInvite from "./bottom_components/ArchivedInvite";
import WaitingForAccept from "./bottom_components/WaitingForAccept";
import ProjectInProgress from "./bottom_components/ProjectInProgress";
import CompletedProject from "./bottom_components/CompletedProject";
