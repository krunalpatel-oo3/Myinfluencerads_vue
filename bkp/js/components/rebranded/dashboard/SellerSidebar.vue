<template>
  <div>
    <div class="img-container">
      <img :src="`${publicPath}Proposals-hero.png`" alt="">
    </div>
    <router-link to="">
      <p class="name">John William</p>
    </router-link>
    <div style="width: 100%; display: flex; justify-content: center; margin-bottom: 41px">
      <span>Seller</span>
    ...
    <div class="card">
      <div class="row mx-0 align-items-center" style="margin-top: 14px">
        ...
        <router-link to="">
          <p class="h">Total earned</p>
        </router-link>
      </div>
      <p class="sub">$ 12,537.00</p>
    </div>
    <div class="card">
      <div class="row mx-0 align-items-center" style="margin-top: 14px">
        <SidebarLine style="margin-left: 11.79px; margin-right: 8px"/>
        <router-link to="">
          <p class="h">Total tracked hours</p>
        </router-link>
      </div>
      <p class="sub">357 hrs</p>
    </div>
    <div class="card">
      <div class="row mx-0 align-items-center" style="margin-top: 14px">
        <SidebarLine style="margin-left: 11.79px; margin-right: 8px"/>
        <router-link to="">
          <p class="h">Total amount in scrow</p>
        </router-link>
      </div>
      <p class="sub">$ 12,537.00</p>
    </div>
    <div class="card">
      <div class="row mx-0 align-items-center" style="margin-top: 14px">
        <SidebarLine style="margin-left: 11.79px; margin-right: 8px"/>
        <router-link to="">
          <p class="h">Total pending amount</p>
        </router-link>
      </div>
      <p class="sub">$ 12,537.00</p>
    </div>
