<template>
  ...
  >
    <div
      class="modal-close"
      @click="$modal.hide('open-dispute-dialog')"
    >
      <CloseIcon />
    </div>
    <div class="row">
      <h2 class="w700 poppins t-33" style="margin-bottom: 17px">File a Dispute</h2>
      <div class="form-group">
        <h3 class="w700 t-28 poppins" style="margin-bottom: 5px">Reason</h3>
        <textarea
          class="form-control roboto"
          placeholder="Add reason for dispute"
        ></textarea>
        <div class="btns">
