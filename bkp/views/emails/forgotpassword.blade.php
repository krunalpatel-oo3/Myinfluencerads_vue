            ...
            <tr>
                <td class="email_main_body">
                    <table align="center" border="0" cellpadding="0" cellspacing="0" class="main_table">
                        <tr class="header_tr">
                            <td>
                                <img src="{{ asset('images/forgot-email-h.png') }}" id="h-img" alt="">
                            </td>
                        </tr>
                        <tr>
                            <td class="email_body">
                                <h4 class="heading1">Password Reset</h4>
                                <p class="text_tag">
                                    There was a request to change your password for your account.
                                </p>
                                <p class="text_tag">
                                ...
                                <a href="{!!$confirm_url!!}" class="btn">Reset Password</a>
                            </td>
                        </tr>
                    </table>
                </td>
