            ...
            <tr>
                <td class="email_main_body">
                    <table align="center" border="0" cellpadding="0" cellspacing="0" class="main_table">
                        ...
                        <tr>
                            <td class="email_body">
                                <h4 class="heading1">Subscription Downgrade Confirmation</h4>
                                <p class="text_tag">
                                    Thank you for using the StreamGeeks subscription plan. We've successfully changed your subscription to the "{{$planName}}" Plan.
                                </p>    
                                <p class="text_tag">    
                                    You can access your subscription information from your "Settings Page – Plans" for any changes. 
                                </p>
