            ...
            <tr>
                <td class="email_main_body">
                    <table align="center" border="0" cellpadding="0" cellspacing="0" class="main_table">
                        <tr class="header_tr">
                            <td>
                                <img src="{{ asset('images/registration-email-h.png') }}" id="h-img" alt="">
                            </td>
                        </tr>
                        <tr>
                            <td class="email_body">
                                <h4 class="heading1">Welcome to StreamGeeks</h4>
                                <p class="text_tag">
                                    Congratulations, your account has been successfully created. To verify your email address and complete your account creation, please click the verification button below or copy and paste the address into your browser:
                                </p>
                                <div class="clearfix"></div>
                                <a href="{!!$m_additiveVars['confirm_url']!!}" class="btn">Verify Email</a>
                            </td>
                        </tr>
                    </table>
                </td>
